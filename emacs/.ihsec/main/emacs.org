...
** MPDel
   ...
   #+begin_src emacs-lisp
     (use-package mpdel
       ...
       (mpdel-tablist-mode . luc/toggle-debug-on-error)
       :init
...
*** Changes to the source code
    ...
    3. Changing the formatting and layout of the playlist. 
       ...
       navigel-entity-to-columns ((song libmpdel-song))=.
    ...
    needs/problems, the code above alone will work just fine for you.
** Org Mode
