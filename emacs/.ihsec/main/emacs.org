...
** MPDel
   ...
   album artist names, album contents not displaying properly and lag
   when receiving =error in process filter: Quit=, mainly. But I'm still
   excited to tweak around, if it works like I'm imagining it can, I'd
   be happy to make it my new MPD client.
   ...
   #+begin_src emacs-lisp
     (use-package mpdel
       ...
       ;; I usually search for the album artist tag, so I made that possible here.
