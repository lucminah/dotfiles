...
*** General
    The package I use to manage all my custom keybindings. I find it
...
** Ivy, Counsel & Swiper
   ...
   Ivy Rich, for getting details on each selectable option. Also
...
** Company
   An autocompletion package. Very comfortable to use and highly
...
*** Scaling windows
    ...
    scale. This hydra makes is a lot easier.
    #+begin_src emacs-lisp
...
** Magit & Forge
   Amazingly powerful Git frontend. I hadn't known of it before, but
