...
** Outline Minor Mode
   ...
   #+begin_src emacs-lisp
     (use-package outline
       :init
       ;; `imenu' will match `outline-minor-mode' headings. Sounds
       ;; reasonable since what makes something a heading matches the
       ;; points of interest I'd like to jump to, but I'll still look more
       ;; into configuring this.
